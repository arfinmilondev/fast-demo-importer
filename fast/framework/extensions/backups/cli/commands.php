...
namespace Fast\Extension\Backups;

/**
 * Fast Backups Extension CLI Commands.
 *
 * @package wp-cli
 */
class Command extends \Fast\Extension\Command {
	 ...
	 *     $ wp fast ext backups create
	 *     Backup successfully created
	 *
	 *     # Create full backup
	 *     $ wp fast ext backups create --full
	 *     Backup successfully created
	 *
	 *
	 * @param array $args
	 ...
	 *
	 *     # Restore backup
	 *     $ wp fast ext backups restore fw-backup-2017_03_25-05_58_28-2.0.23

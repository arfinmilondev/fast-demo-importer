...
?>
<h2><?php esc_html_e('Fast Demo Content Install', 'fw') ?></h2>
<?php echo apply_filters('fast_demo_importer_warning', ''); //@fast 
?>
<div>
	...
	<?php if ($http_loopback_warning = fw_ext_backups_loopback_test()) : ?>
		...
		<script type="text/javascript">
			var fw_ext_backups_loopback_failed = true;
		</script>
	<?php endif; ?>
</div>
	...
	<?php foreach ($demos as $demo) : ?>
		<div class="theme fw-ext-backups-demo-item" id="demo-<?php echo esc_attr($demo->get_id()) ?>">
			...
			<div class="theme-actions">
				<a class="button button-primary" href="#" onclick="return false;" data-confirm="<?php echo esc_attr($confirm); ?>" data-install="<?php echo esc_attr($demo->get_id()) ?>"><?php esc_html_e('Install', 'fw'); ?></a>
			</div>
		</div>
	<?php endforeach; ?>
</div>
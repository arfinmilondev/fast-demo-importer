...
class FW_Ext_Backups_Task_Type_DB_Restore extends FW_Ext_Backups_Task_Type
{
	...
	{
		return 10; // Fixes https://github.com/ThemeFuse/Fast/issues/1818
	}
	...
	private function get_tables()
	{
		 ...
		 * Fixes https://github.com/ThemeFuse/Fast/issues/2068#issuecomment-250196792
		 */
	...
	private function do_import(array $args, array $state)
	{
		 ...
		 */ {
			...
			foreach ($search_replace as $search => $replace) {
				 ...
				 * Fixes https://github.com/ThemeFuse/Fast-Backups-Extension/issues/23
				 */
		 ...
		 * Fixes https://github.com/ThemeFuse/Fast-Backups-Extension/issues/27
		 */ {
					...
					case 'row':
						...
						if (
							...
							if (isset($replace_option_names[$line['data']['row']['option_name']])) {
								 ...
								 * Prevent 'Duplicate entry' error https://github.com/ThemeFuse/Fast-Backups-Extension/issues/34
								 *
								 * This happens when:
								 ...
								 * 2) On Fast Demo Content Import 'stylesheet' or 'template' is 'theme-name'
							...
							while ($line['data']['row']) {
								...
								if (false === $wpdb->query($sql)) {
									if (
										 ...
										 * Fixes https://github.com/ThemeFuse/Fast/issues/1952
										 */

			...
			'<div class="notice notice-warning">
				<p><strong>Fast: </strong>' .
					sprintf(
						...
						'<a href="http://manual.fast.io/en/latest/extension/backups/index.html#litespeed-webserver" target="_blank">',
						'</a>'
					) .
				'</p>
			</div>';
		...
		do {
			 ...
			 */
			{
				$output_buffer_size = max(
					// https://github.com/ThemeFuse/Fast/issues/2070#issuecomment-258427852

...
class FW_Extension_Update extends FW_Extension {
	...
	public function _action_admin_menu() {
		...
		if ( ! is_multisite() || is_plugin_active_for_network( 'fast/fast.php' ) ) {
			return;
		}

		add_submenu_page( 'admin.php', esc_html__( 'Fast updates', 'fw' ), '', 'update_plugins', 'fw-update', array( $this, '_multisite_updates_page' ) );
	}
	...
	public function _action_admin_notices() {
		...
		$slug = is_multisite() && ! is_plugin_active_for_network( 'fast/fast.php' ) ? '?page=fw-update' : 'update-core.php#fw-ext-update-extensions';

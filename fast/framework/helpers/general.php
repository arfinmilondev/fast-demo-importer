...
function fw_stripslashes_deep_keys( $value ) {
	...
	if ( $magic_quotes === null ) {
		$magic_quotes = false; //https://www.php.net/manual/en/function.get-magic-quotes-gpc.php - always returns FALSE as of PHP 5.4.0. false fixes https://github.com/ThemeFuse/Fast/issues/3915
	}
 ...
 * https://github.com/ThemeFuse/Fast/commit/07be8b1f4b50eaf0f1f7e85ea1c6912a0415d241#diff-cf866bf08b8f747e3120221a6b1b07cfR48
...
function fw_get_google_fonts_v2() {
	...
	if (
		...
		$response = wp_remote_get( apply_filters( 'fw_googleapis_webfonts_url',
			'https://google-webfonts-cache.fast.io/v1/webfonts' ) );
